...
export interface QuickEntryNewItem{name:string;brand:string|null;entityPurpose:string|null;categoryId:number|null;unitOfMeasure:string|null;monthlyRequiredQuantity:number;expirationDate:string|null;}
