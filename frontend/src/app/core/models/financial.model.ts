...
export interface FinancialMovement{id:number;itemName:string;movementType:StockMovementType;quantity:number;unitValue:number;totalValue:number;exitTypeName:string|null;responsibleName:string|null;eventName:string|null;notes:string|null;createdAt:string;}
