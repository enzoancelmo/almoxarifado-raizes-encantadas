...
export interface StockReport{id:number;name:string;categoryName:string;quantity:number;minimumStock:number;costPrice:number;salePrice:number;expirationDate:string|null;status:ProductStatus;stockValue:number;}
