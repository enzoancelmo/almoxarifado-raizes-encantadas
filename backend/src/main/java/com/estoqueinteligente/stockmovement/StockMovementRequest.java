...
public class StockMovementRequest{
 ...
 @DecimalMin(value="0.0",message="Valor unitário não pode ser negativo") private BigDecimal unitValue; private Long entryTypeId; private Long exitTypeId;
 ...
 public BigDecimal getUnitValue(){return unitValue;}public void setUnitValue(BigDecimal v){unitValue=v;}public Long getEntryTypeId(){return entryTypeId;}public void setEntryTypeId(Long v){entryTypeId=v;}public Long getExitTypeId(){return exitTypeId;}public void setExitTypeId(Long v){exitTypeId=v;}
}
