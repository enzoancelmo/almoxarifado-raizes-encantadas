...
public class ProductResponse {
    ...
    private final BigDecimal purchaseValue,exitValue,totalInventoryValue;
    ...
    ProductResponse(Product p,ProductStatus status){
        ...
        totalInventoryValue=purchaseValue.multiply(BigDecimal.valueOf(currentQuantity));
    ...
    public BigDecimal getPurchaseValue(){return purchaseValue;} public BigDecimal getExitValue(){return exitValue;} public BigDecimal getTotalInventoryValue(){return totalInventoryValue;}
